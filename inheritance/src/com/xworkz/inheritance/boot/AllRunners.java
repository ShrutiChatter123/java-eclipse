...
import com.xworkz.inheritance.thing.Institute;
import com.xworkz.inheritance.thing.Metal;
import com.xworkz.inheritance.thing.Mysore;
import com.xworkz.inheritance.thing.PalaceCity;
...
import com.xworkz.inheritance.thing.Xworkz;
...
public class AllRunners {
	...
	public static void main(String[] args) {
		...
		TechCompany techCompany = new Apple();
		TechCompany techComany = new TechCompany();

		System.out.println("----------------");

		BreakFast breakfast = new BreakFast();
		Dosa dosa = new BreakFast();
		Dosa dosa1 = new Dosa();

		System.out.println("-------------");
		
		Square sqr=new Square();
		Table table=new Square();
